  ...
  return (
    <>
          ...
          >
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Upload, own, and share African art, music, stories, and
                performances with proof of authenticity powered by Hedera.
              </motion.p>
      ...
      <section className="mx-auto bg-[#4169a4]">
        <div
          className="container py-20 mx-auto text-center bg-[#eeeeee]"
      ...
      <section className="py-20 px-45 text-center text-white bg-[#4169a4]">
        <h2 className="text-6xl font-bold">
          Be part of the movement to preserve Africa’s culture for future
          generations.
        </h2>
