      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <h2 className="text-5xl font-bold">
            Ready to Share Your{" "}
            <span className="text-gradient">Art</span> with the World?
          </h2>
          
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Join thousands of African artists already earning from their creativity. 
            Mint your first NFT today and connect with collectors globally.
          </p>
          
          <div className="flex flex-wrap justify-center gap-4 pt-4">
            <Button size="lg" className="gradient-warm border-0 text-lg px-8 hover-lift">
              Mint Your First NFT
